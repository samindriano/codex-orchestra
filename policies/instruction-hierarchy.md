...
and its workers remain GPT-6 Luna XHigh; effort never escalates automatically. A project
...
the GPT-6 Luna XHigh root default; updates preserve any existing root model
